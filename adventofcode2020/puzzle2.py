...
def validpasswords(passwords):
    ...
    for password in passwords:
        blah = password.split(' ')
        print(blah)
        instances = blah[0].split('-')
        min_for_letter = int(instances[0])
        max_for_letter = int(instances[1])
        letter = blah[1].strip(':')
        curr_pwd = blah[2]
        ...
        if min_for_letter <= count <= max_for_letter:
            print(password)
            valid_pwds += 1
...
#validpasswords(example_passwords)
#validpasswords(my_passwords)

def validpositions(passwords):
    valid_pwds = 0
    for password in passwords:
        blah = password.split(' ')
        #print(blah)
        instances = blah[0].split('-')
        p1 = int(instances[0]) - 1
        p2 = int(instances[1]) - 1
        letter = blah[1].strip(':')
        curr_pwd = blah[2]

        if (curr_pwd[p1] == letter) ^ (curr_pwd[p2] == letter):
            print(password)
            valid_pwds +=1
...
#validpositions(example_passwords)
validpositions(my_passwords)
